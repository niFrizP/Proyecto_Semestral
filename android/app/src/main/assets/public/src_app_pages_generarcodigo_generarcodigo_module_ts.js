...
/* harmony import */ var _generarcodigo_page_html_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./generarcodigo.page.html?ngResource */ 6693);
/* harmony import */ var _generarcodigo_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./generarcodigo.page.scss?ngResource */ 794);
...
GenerarcodigoPage = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
  selector: 'app-generarcodigo',
  template: _generarcodigo_page_html_ngResource__WEBPACK_IMPORTED_MODULE_1__,
  styles: [_generarcodigo_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__]
})], GenerarcodigoPage);
...
const createCapacitor = win => {
  ...
  const defaultRegisterPlugin = (pluginName, jsImplementations = {}) => {
    ...
    const loadPluginImplementation = /*#__PURE__*/function () {
      var _ref = (0,C_Users_nikoo_Documents_GitHub_Proyecto_Semestral_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    ...
    const createPluginMethodWrapper = prop => {
      ...
      const wrapper = (...args) => {
        ...
        if (prop === 'addListener') {
          p.remove = /*#__PURE__*/(0,C_Users_nikoo_Documents_GitHub_Proyecto_Semestral_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
            return remove();
          });
        }
    ...
    const addListenerNative = (eventName, callback) => {
      ...
      const remove = /*#__PURE__*/function () {
        var _ref3 = (0,C_Users_nikoo_Documents_GitHub_Proyecto_Semestral_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
...
class WebPlugin {
  ...
  addListener(eventName, listenerFunc) {
    ...
    const remove = /*#__PURE__*/function () {
      var _ref5 = (0,C_Users_nikoo_Documents_GitHub_Proyecto_Semestral_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    ...
    Object.defineProperty(p, 'remove', {
      value: function () {
        var _ref6 = (0,C_Users_nikoo_Documents_GitHub_Proyecto_Semestral_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
          console.warn(`Using addListener() without 'await' is deprecated.`);
          yield remove();
        });
